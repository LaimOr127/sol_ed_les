...
describe('tree', () => {
    ...
    describe('after adding a node', () => {
        ...
        it('should have a root', () => {//проверяем, что корень не равен null
        ...
        describe('after adding a lesser node', () => {
            ...
            it('should have add a left to the root', () => {//тест на добавление левого узла
            ...
            describe('after adding another lesser node', () => {
                ...
                it('should have add to the left node', () => {//тест на проверку левого узла
            ...
            describe('after adding another lesser node', () => {
                before(() => {
                    tree.addNode(new Node(4));//добавляем еще один узел
                });

                it('should have add to the left node', () => {
                    assert(tree.root.left.right, "did not find a right on the left node on the root!");//проверяем, что правый узел существует
