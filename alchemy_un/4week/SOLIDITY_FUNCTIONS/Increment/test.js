...
describe('Contract', function () {
    ...
    it('should set the initial value to 0', async () => {//тест на начальное значение
    ...
    describe('after one increment call', () => {
        ...
        it('should increase the value to 1', async () => {//тест на увеличение значения
            const x = await contract.callStatic.x();
    ...
    describe('after a second increment call', () => {
        ...
        it('should increase the value to 2', async () => {//тест на увеличение значения
            const x = await contract.callStatic.x();
