...
describe('Contract', function () {
    ...
    it('should create two variables, one positive and one negative', async () => {//тест на то, что одна переменная положительная, а другая отрицательная
    ...
    it('should find the absolute difference between the two variables', async () => {//тест на то, что разность между переменными равна модулю разности
        const a = await contract.callStatic.a();
        const b = await contract.callStatic.b();
